...
class MatchAdapter(private val match: List<MatchItems>, private val listener: (MatchItems) -> Unit): RecyclerView.Adapter<MatchAdapter.ViewHolder>(){
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindItem(item: MatchItems, listener: (MatchItems) -> Unit){
